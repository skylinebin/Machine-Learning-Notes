...
'''
The DQN brain
The network contains two parts: evaluate_net and target_net
Each of them has a three layer structure
@editor skylinebin
@date 2018-01-24 21:32:38
...
class DeepQNetwork:
    ...
    def store_transition(self, s, a, r, s_):
        ...
        # print('old_s:',(s, [a, r], s_))

        transition = np.hstack((s, [a, r], s_))
        # print('old_transition:',transition)
